...
const ServiceName = "sandboxd-agent"
...
type UnitParams struct {
	// Executable is the absolute path to the sandboxd-agent binary.
	Executable string
...
func (p UnitParams) SystemdUnit() string {
	...
	// agent supervises. That turns `systemctl restart sandboxd-agent`, and
