...
const (
	ForwardService_Forward_FullMethodName = "/sandboxd.v1.ForwardService/Forward"
)
...
var ForwardService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sandboxd.v1.ForwardService",
	...
	Metadata: "sandboxd/v1/forward.proto",
}
